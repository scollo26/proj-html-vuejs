<template>
<div class="row row-cols-2 pt-5 pb-5 ">
    <!-- prima colonna form -->
    <div class="col ">
    ...
    <div class="col">
        <div class="contact ms-5">
            ...
            <ul>
                <li><i class="fas fa-phone-alt"></i> <span class="ms-2">+1(305)1234-5678</span></li>
                <li><i class="fas fa-envelope"></i><span class="ms-2">hello@example.com</span></li>
